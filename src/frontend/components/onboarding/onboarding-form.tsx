    ...
    <div className="flex flex-col w-full h-full">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-[#1e3a5f]/60 text-sm">3 questions to get started</p>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-center text-[#2cb1bc] text-xs font-bold">Step {stepIndex} of 3</p>
      </div>
      ...
      <div className="flex gap-3 mb-6 w-full">
        {step !== "interests" && (
          <button
            onClick={() => setStep(step === "energy" ? "interests" : "energy")}
        ...
        >
          ...
          {!loading && step !== "availability" && <ArrowRight className="w-5 h-5" />}
          {!loading && step === "availability" && <CheckCircle2 className="w-5 h-5" />}
        </button>
      </div>
